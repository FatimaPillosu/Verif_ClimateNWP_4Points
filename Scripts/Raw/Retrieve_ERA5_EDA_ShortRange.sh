...
#############################################################################################
# CODE DESCRIPTION
# Retrieve_ERA5_EDA_ShortRange.sh retrieves short-range ERA5_EDA rainfall analysis (63 km spatial resolution).
...
DirOUT="Data/Raw/FC/ERA5_EDA_ShortRange"
#############################################################################################
...
EOF
        ...
        while [[ ${BaseDate} -le ${BaseDateF} ]]; do
            ...
            for BaseTime in 6 18; do
                ...
                for Step in 0 3 6 9 12 15 18; do
