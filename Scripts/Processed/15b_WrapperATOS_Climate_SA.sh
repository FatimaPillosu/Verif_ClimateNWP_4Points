...
# DirIN="Data/Compute/01_AccTP_SA"
# DirOUT_Climate_SA="Data/Compute/02_Climate_SA"
# DirOUT_Climate_G="Data/Compute/03_Climate_G"
...
#       sbatch 02a_SubmitterATOS_Climate_SA.sh ${YearS} ${YearF} ${Acc} ${CodeSA} ${RP_list} ${Dataset_SystemFC} ${Git_Repo} ${DirIN} ${DirOUT_Climate_SA} ${DirOUT_Climate_G}
# done
