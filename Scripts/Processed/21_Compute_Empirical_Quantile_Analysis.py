...
#########################################################################################################
# CODE DESCRIPTION
# 21_Compute_Empirical_Quantile_Analysis.py runs an empirical quantile analysis to assess the similarity between the 
# observational and the NWP modelled rainfall distributions.
# Code runtime: up to 7 min if ~100 percentiles are considered, and up to 37 min if ~10000 percentiles are considered.
...
DirOUT = "Data/Compute/21_Empirical_Quantile_Analysis"
#########################################################################################################
...
# Running the empirical quantile analysis
print()
print("Running the empirical quantile analysis for the different NWP models")
for SystemNWP in SystemNWP_list:
      ...
      print(" - Computing the percentiles for the nwp rainfall realizations...")
      perc_nwp = np.nanpercentile(tp_nwp, Perc_list, axis=1).T

      # Determining the difference between the obs and the nwp percentiles
