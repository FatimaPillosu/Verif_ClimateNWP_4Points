...
for NameOBS in NameOBS_list:
      ...
      if NameOBS == "06_AlignOBS_Combine-Years-RawSTVL":
            ...
            MainDirOUT = Git_repo + "/" + DirOUT + "/" + NameOBS
            ...
            for Coeff_Grid2Point in Coeff_Grid2Point_list:
                  ...
                  MainDirOUT = Git_repo + "/" + DirOUT + "/" + NameOBS + "/Coeff_Grid2Point_" + str(Coeff_Grid2Point)
                  if not exists(MainDirOUT):
                        os.makedirs(MainDirOUT)
