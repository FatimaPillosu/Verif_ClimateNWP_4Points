...
###################################################################################################
# CODE DESCRIPTION
# 04_Plot_Statistic_AD_pycharts.py plots the Anderson-Darling statistic between the observational and the NWP modelled
...
north, west, south and east (negative values for western and southern coordinates).
...
DirOUT = "Data/Plot/04_Statistic_AD_pycharts"
###################################################################################################
