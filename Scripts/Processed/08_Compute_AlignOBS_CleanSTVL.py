...
DirIN_CPC = "Data/Compute/07_AlignOBS_Extract_GridCPC"
DirOUT = "Data/Compute/08_AlignOBS_CleanSTVL"
##################################################################################################################################
...
for Coeff_Grid2Point in Coeff_Grid2Point_list:
      ...
      MainDirOUT_temp = Git_repo + "/" + DirOUT + "/Coeff_Grid2Point_" + str(Coeff_Grid2Point)
      ...
      MainDirIN_CPC = Git_repo + "/" + DirIN_CPC
