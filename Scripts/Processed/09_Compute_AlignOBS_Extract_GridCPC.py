...
#########################################################################################################################
# CODE DESCRIPTION
# 09_Compute_AlignOBS_Extract_GridCPC.py extracts the gridded rainfall values from the "CPC Global Unified Gauge-Based Analysis of Daily 
# Precipitation" dataset for the nearest grid point to each aligned station in the STVL dataset. 
...
MainDirIN_CPC = Git_Repo + "/" + DirIN_CPC + "_" + f'{Acc:02d}' + "h"
